...
namespace ManejoPresupuesto.Servicios {
    ...
    public class ServicioReportes : IServicioReportes {
        ...
        public async Task<IEnumerable<ResultadoObtenerPorSemana>> ObtenerReporteSemanal(
            ...
            (DateTime fechaInicio, DateTime fechaFin) = GenerarFechaInicio_Fin(mes, año);
        ...
        private (DateTime fechaInicio, DateTime fechaFin) GenerarFechaInicio_Fin (int mes, int año){
