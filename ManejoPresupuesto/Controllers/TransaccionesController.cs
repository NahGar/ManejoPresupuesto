...
namespace ManejoPresupuesto.Controllers {
    ...
    public class TransaccionesController: Controller {
        ...
        public async Task<IActionResult> Semanal(int mes, int año) {
            ...
            //arreglo con todos los días del mes
        ...
        public async Task<FileResult> ExportarExcelPorAño( int año ) {
            ...
            var nombreArchivo = $"Manejo_presupuesto_{año.ToString()}.xlsx";
            return GenerarExcel(nombreArchivo, transacciones);
        }
        ...
        public async Task<FileResult> ExportarExcelTodo() {
            ...
            var nombreArchivo = $"Manejo_presupuesto_Todo_{DateTime.Today.ToString("dd-MM-yyyy")}.xlsx";
            return GenerarExcel(nombreArchivo, transacciones);
        }
